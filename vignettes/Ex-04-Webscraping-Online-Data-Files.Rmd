...
![Docker: Pull Selenium](./Docker_Pull_Selenium.png){width=100%}
...
![CCCO Scorecard: College Dropdown.](./Scorecard_College_Dropdown.png){width=100%}
...
![CCCO Scorecard: Irvine Valley College.](./Scorecard_IVC.png){width=100%}
...
![CCCO Scorecard: Download Button.](./Scorecard_Download_Button.png){width=100%}
...
![Starting the Selenium Server in Docker.](./Docker_Run.png){width=100%}
...
![RSelenium Screenshot: Scorecard Site.](./RSelenium_Screenshot_Scorecard.png){width=100%}
...
![Scorecard Downloaded Files.](./Scorecard_Downloaded_Files.png){width=100%}
...
![Stopping the Selenium Server in Docker.](./Docker_Stop.png){width=100%}
...
![Student Success Metrics: Landing Page.](./SSM_Landing_Page.png){width=100%}
...
![Student Success Metrics: All Students journey for Irvine Valley College](./SSM_All_Students_College.png){width=100%}
...
![SelectorGadget: All Students](./SelectorGadget_All_Students.png){width=100%}

![SelectorGadget: All Students XPath](./SelectorGadget_All_Students_XPath.png){width=100%}
...
![SelectorGadget: College Radio Button](./SelectorGadget_College_Button.png){width=100%}
...
![SelectorGadget: View Button](./SelectorGadget_View_Button.png){width=100%}
...
![SelectorGadget: Export Data to CSV](./SelectorGadget_Export.png){width=100%}
...
![SelectorGadget: Journey Type Dropdown Menu](./SelectorGadget_Journey_Type_Dropdown.png){width=100%}

![SelectorGadget: College Dropdown Menu](./SelectorGadget_College_Dropdown.png){width=100%}
...
![Chrome: Developer Tools](./Chrome_Developer_Tools.png){width=100%}
...
![Chrome: Select An Element](./Chrome_Select_An_Element.png){width=100%}

Move the mouse cursor over the *All Students* link and click it for the console to show a description of it, as seen here:

![Chrome: Select *All Students* link](./Chrome_Select_All_Students.png){width=100%}
...
![RSelenium Screenshot: After Click the View Button.](./RSelenium_Screenshot_View_Button.png){width=100%}
...
The above code should save the CSV files on the host computer's `Downloads/Selenium-Downloads` folder.
